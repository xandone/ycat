...
<table class="easyui-datagrid" id="itemList" title="段子列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/ycat/joke/list',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
        <tr>
            <th data-options="field:'ck',checkbox:true"></th>
        	<th data-options="field:'joke_id',width:100">段子ID</th>
            <th data-options="field:'joke_user_id',width:100">作者ID</th>
...
<div id="itemEditWindow" class="easyui-window" title="编辑段子" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/rest/page/item-edit'" style="width:80%;height:80%;padding:10px;">
</div>
<script>
